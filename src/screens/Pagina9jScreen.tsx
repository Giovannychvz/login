...
export const Pagina9jScreen = ({navigation}: Props) => {
...
//console.log("emaiul " + global.email_1 + " clave " + global.password + " clave2 " + global.password2);
