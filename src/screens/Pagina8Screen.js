...
export const Pagina8Screen = ({navigation} ) => {
...
const validateData = () =>{
   ...
   if(celular !== celulara){
    Alert.alert(
      "DATOS NO COINCIDEN",
      "Los Números de Celular deben ser Iguales, favor realizar la corrección",
      [
        {
          text: "Aceptar",
          style: "cancel",
   ...
   if(celular.length < 10){
    Alert.alert(
      "CAMPO OBLIGATORIO",
      "Debe llevar mínimo 10 caracteres el número celular",
      [
        {
          text: "Aceptar",
          style: "cancel",
   ...
   if(email_1 !== email_2){
    Alert.alert(
      "DATOS NO COINCIDEN",
      "Los Emails deben ser Iguales             favor realizar la corrección",
