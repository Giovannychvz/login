...
export const AuthProvider = ({children}: any) =>{
    ...
    const checkToken = async () =>{
       ...
       if (!token) return dispatch({ type:'notAuthenticated'});
             ...
             //hay token
       //await fetch('https://portal.tuparcero.com/apiTuparcero/usuarios/login.php',
      // const resp = await cafeApi.get('/auth');
      // const resp = await cafeApi.get('/usuarios/user-info.php');
      const resp = await cafeApi.get('/usuarios/user-info.php');
       //const resp = await fetch('https://portal.tuparcero.com/apiTuparcero/usuarios/user-info.php');
    ...
    const signUp = async ({name, email, password, tipo_usuario}: RegisterData) => {
        ...
        try { /*
            ...
            */
            ...
            await  fetch('https://www.deportes.controlsas.com/apiPlooy/usuarios/register.php',
    {
      method:'POST',
      headers:{
        'Accept': 'application/json',
